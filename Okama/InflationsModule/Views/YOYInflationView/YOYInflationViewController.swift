//
//  YOYCombinedViewController.swift
//  Okama
//
...
class YOYInflationViewController: ViewControllerWithLoadingView, ChartViewDelegate {
...
extension YOYInflationViewController: CurrencyView {
   
   func showData(inflation: Inflation) {
      if let yoyInflations = inflation.yoyInflations {
         stopLoadingAnimation()
        
         let combData = CombinedChartData(timeSeriesValues: yoyInflations, label: "Inflation")
